...
const columns = [
    { key: "rank", label: "#" }, { key: "team_name", label: "Takım" },
    { key: "played", label: "O" }, { key: "wins", label: "G" }, { key: "draws", label: "B" }, { key: "losses", label: "M" },
    { key: "points", label: "Pts" },
];
const Standings = () => <CrudPage title="Puan Durumu" collection="standings" fields={fields} columns={columns} defaultValues={{ season: "2025-2026" }} />;
